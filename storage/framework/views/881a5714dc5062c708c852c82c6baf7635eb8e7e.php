...
<?php $__env->startSection('auth_header', 'REGISTAR-SE COMO EMPRESA'); ?>

<?php $__env->startSection('auth_body'); ?>
    <form action="<?php echo e(route('trainee.create')); ?>" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="name" class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"
                   value="<?php echo e(old('name')); ?>" placeholder="Nome" autofocus>
...
<?php $__env->startSection('auth_footer'); ?>
    <p class="my-0">
        <a href="<?php echo e(route('trainee.login')); ?>">
            Já me registei. Fazer login
        </a>
    </p>
    <p class="my-0">
        <a href="<?php echo e(route('instructor.register')); ?>">
            Registar-se como freelancer
        </a>
    </p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'register'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelancers/resources/views/dashboard/trainee/register.blade.php ENDPATH**/ ?>