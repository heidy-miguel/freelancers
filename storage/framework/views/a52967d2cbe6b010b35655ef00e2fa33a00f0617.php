  ...
  <div class="bs-stepper-content">
    ...
    <form>
      ...
      <div id="language-part" class="content" role="tabpanel" aria-labelledby="language-part-trigger">
        <div class="form-group">
          <ul>
            <?php $__currentLoopData = Auth::guard('instructor')->user()->languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li><?php echo e($lang->name); ?></li>
      ...
      <!-- /.modal --><?php /**PATH /opt/lampp/htdocs/freelancers/resources/views/layouts/form_model.blade.php ENDPATH**/ ?>