...
<?php $__env->startSection('auth_header', 'LOGIN COMO FREELANCER'); ?>

<?php $__env->startSection('auth_body'); ?>
    <form action="<?php echo e(route('instructor.check')); ?>" method="post">
...
<?php echo $__env->make('adminlte::auth.auth-page', ['auth_type' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelancers/resources/views/dashboard/instructor/login.blade.php ENDPATH**/ ?>