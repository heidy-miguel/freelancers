...
unset($__errorArgs, $__bag); ?></span>
                     ...
                     <br>
                     <a href="<?php echo e(route('instructor.register')); ?>">Create new Account</a>
                 </form>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH /opt/lampp/htdocs/freelancers/resources/views/dashboard/instructor/login.blade.php ENDPATH**/ ?>